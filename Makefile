...
_DEF_COMP_TIME = SO_BLOCK_SIZE=10 SO_REGISTRY_SIZE=1000 _FORTIFY_SOURCE=2 _GNU_SOURCE DEBUG DEBUG_NODE #DEBUG_USER #DEBUG_MAIN
...
_DEPENDENCIES_NODE = conf_file.h boolean.h simulation_errors.h debug_utility.h semaphore.h transaction_list.h process_info_list.h node_transactor.h node_msg_report.h glob.h master_msg_report.h node_msg_report.h shm_conf.h book_master_shm.h node_tp_shm.h int_condenser.h
DEPENDENCIES_NODE = $(patsubst %, $(SOURCE_HEADERS_DIR)/%, $(_DEPENDENCIES_NODE))
# Objects
_OBJECTS_MAIN = main.o conf_file.o process_info_list.o semaphore_wrap.o user_msg_report.o master_msg_report.o node_msg_report.o shm_conf.o book_master_shm.o int_condenser.o transaction_list.o
...
_OBJECTS_NODE = node_proc.o process_info_list.o conf_file.o semaphore_wrap.o node_transactor.o transaction_list.o user_msg_report.o node_msg_report.o master_msg_report.o shm_conf.o book_master_shm.o int_condenser.o int_condenser.o
