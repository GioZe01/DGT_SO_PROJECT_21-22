...
_DEF_COMP_TIME = SO_BLOCK_SIZE=10 SO_REGISTRY_SIZE=1000 _FORTIFY_SOURCE=2 _GNU_SOURCE #DEBUG #DEBUG_USER
DEF_COMP_TIME = $(patsubst %, -D%, $(_DEF_COMP_TIME))



# Dipendenze
_DEPENDENCIES_MAIN =  glob.h conf_file.h boolean.h simulation_errors.h debug_utility.h process_info_list.h semaphore.h user_msg_report.h master_msg_report.h node_msg_report.h shm_conf.h book_master_shm.h int_condenser.h
...
# Objects
_OBJECTS_MAIN = main.o conf_file.o process_info_list.o semaphore_wrap.o user_msg_report.o master_msg_report.o node_msg_report.o shm_conf.o book_master_shm.o int_condenser.o
OBJECTS_MAIN = $(patsubst %, $(BUILD_OBJECT_DIR)/%, $(_OBJECTS_MAIN))
_OBJECTS_USER = user_proc.o process_info_list.o conf_file.o semaphore_wrap.o user_transaction.o transaction_list.o user_msg_report.o node_msg_report.o master_msg_report.o shm_conf.o int_condenser.o
OBJECTS_USER = $(patsubst %, $(BUILD_OBJECT_DIR)/%, $(_OBJECTS_USER))
_OBJECTS_NODE = node_proc.o process_info_list.o conf_file.o semaphore_wrap.o node_transactor.o transaction_list.o user_msg_report.o node_msg_report.o master_msg_report.o shm_conf.o book_master_shm.o int_condenser.o
