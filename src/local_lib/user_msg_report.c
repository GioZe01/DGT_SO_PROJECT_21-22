...
int
user_msg_snd(int id, struct user_msg *msg, long type, struct Transaction *t, pid_t sender, Bool create, int queue_id) {
...
int check_user_type(int type_given, int queue_id) {
    switch (type_given) {
        ...
        case MSG_TRANSACTION_INCOME_TYPE:
            return queue_id - MSG_TRANSACTION_FAILED_TYPE;
        case MSG_TRANSACTION_FAILED_TYPE:
            return queue_id - MSG_TRANSACTION_INCOME_TYPE;
        default:
