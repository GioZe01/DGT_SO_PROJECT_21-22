...
#define DEBUG_NOTIFY_ACTIVITY_RUNNING(mex) fprintf(stderr,"%s%s [DEBUG-NOTIFY]:= %s%s\n", COLOR_RESET_ANSI_CODE,COLOR_YELLOW_ANSI_CODE,mex,COLOR_RESET_ANSI_CODE)
#define DEBUG_NOTIFY_ACTIVITY_DONE(mex) fprintf(stderr,"%s%s [DEBUG-NOTIFY]:= %s%s\n", COLOR_RESET_ANSI_CODE,COLOR_GREEN_ANSI_CODE,mex,COLOR_RESET_ANSI_CODE)
