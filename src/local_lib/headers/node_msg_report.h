...
#define MSG_TRANSACTION_TYPE 2 /*DEFAULT */

#define CHECK_DEFAULT(type_recived, queue_id) type_recived-queue_id == 0 ? MSG_TRANSACTION_TYPE : type_recived-queue_id
 ...
 * @param is_node_origin is the message generated by the node itself
